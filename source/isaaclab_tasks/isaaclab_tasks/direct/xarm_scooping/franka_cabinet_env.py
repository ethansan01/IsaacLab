...
@configclass
class XarmScoopingEnvCfg(DirectRLEnvCfg):
    # env
...
class XarmScoopingEnv(DirectRLEnv):
    ...
    cfg: XarmScoopingEnvCfg

    def __init__(self, cfg: XarmScoopingEnvCfg, render_mode: str | None = None, **kwargs):
